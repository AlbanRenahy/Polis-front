        ...
        <div className="dysplay-donnees_relative">
          <header>
            ...
            <div className="header-info">
              <h2 className="header-info-name">Notre Dame d'Amiens</h2>
              <h2 className="header-info-user">
                Renseigné par <strong>Jean-Luc Legrand</strong>
              </h2>
              <h3 className="header-info-address">
                Place de la Cathédrale, 80300 Amiens
              </h3>
              <div className="header-info-bottom--panel">
                <p className="header-info-tag">2h de visite</p>
              </div>
            </div>
          </header>
          <hr />
          <div className="panel-description">
            ...
            <p className="panel-description-text">
              Cette Cathédrale possède la plus haute nef de France !
            </p>
          </div>
          <hr />
